...
function displayModal(messageId, imgId){
  userClick({message: 'modalOpen', messageId: messageId, imgId: imgId});
  extend = false;
  ...
  document.getElementById('caption').innerHTML += "<p id='tags'></p><hr><div id='palette'></div><p id='colorName'>plop</p><p id='price'></p>";
